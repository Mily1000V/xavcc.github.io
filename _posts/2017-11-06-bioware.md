...
Tu utilises des applis Nike ou Aplle pour leur offrir des informations sur ta santé lors de ton footing, des sextoys connectés piratables ([Screwdriving. Locating and exploiting smart adult toys](https://www.pentestpartners.com/security-blog/screwdriving-locating-and-exploiting-smart-adult-toys/)), tu poses des questions sur ta santé via internet (navigateur, moteur de recherche, ordinateur et wifi non sécurisés)...
...
Alors, pour répondre à problèmes de failles dans l'infrastrure autant trouver cette faille, l'exploiter pour intérroger et donner à lire, voir, réutiliser et améliorer librement ce qui a été "pris à son propre jeu" (pas simple de raduire powned en français). 
...
[Fqzcomp](https://sourceforge.net/projects/fqzcomp/), un compresseur de base de fastq, conçu principalement pour la haute performance. Malgré cela, il est comparable à bzip2 pour les niveaux de compression.
