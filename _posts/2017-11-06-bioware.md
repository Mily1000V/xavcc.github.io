...
Si vous désirez pousser pllus loin la réflexion sur le numérique et les fonctionnement des internets, vous avez quelques ressources supplémentaires à disposition en fin de cette article.
...
Alors, pour répondre à des problèmes de failles dans l'infrastrure autant trouver cette faille, l'exploiter pour intérroger et donner à lire, voir, réutiliser et améliorer librement ce qui a été "pris à son propre jeu" (pas simple de raduire powned en français). 
...
Par exemple, si vous amez l'art, vous pouvez tenter "une ferme à rotifères" chez vous pour nourrir des micro-oragnismes avec votre salive (Cf [article traduit en français](https://xavcc.github.io/science/2017/04/26/rotifer-bioacking.html)). Puis utliser les rotifères 

Si vou voulez pousser plus loin, entrainez vous sur l'outil, (sur des données issues de vos rotifères ?), [`Fqzcomp`](https://sourceforge.net/projects/fqzcomp/), un compresseur de base de fastq, conçu principalement pour la haute performance. Malgré cela, il est comparable à `bzip2` pour les niveaux de compression. C'est celui qu'on utilisé les chercheurs du _UW CSE Security and Privacy Research Lab_ dans la prouesse évoquée précdemment, cela vous permettra d'être sur un pied d'agalite, voir même d'améliorer les conditions de sécurité.

## _PenTest your biological sanctuary"_

La curiosité de chaque individu devrait le pousser à s'interesser comment "les choses" sont assemblées et comment elle focntionne, c'est qui amène, par exemple, à démonter un ordianteur et revoir la loi d'Ohm pour comprendre les intéractions entre hardware et software. Puis, toutjours dans cette démarche de curiosité, de lancer des "tests de pénétration" pour évaluer le dégrè de fiabilité d'un machine, d'un logiciel, d'un infrastructure. 
...
Je vous suggère, en guise de mise ne mise en bouche, de vous initier à `tcpdump` sur votre ordinateur via ce [tutoriel](https://hackmd.io/s/r1Mfb9FVW) et de tester un appareil qui recueil vos données physio ou biologique ; e.g smartphone et appli photo avec filtre facial, 
