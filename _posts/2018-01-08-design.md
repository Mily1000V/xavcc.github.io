...
### Défi 1 "TravelTxt, La vie privée est une composante du numérique ? Dans ce cas que fait cette start-up ?"
...
traceroute to traveltxt.net (108.168.244.211), 30 hops max, 60 byte packets
 1  gateway (192.168.0.1)  0.815 ms  1.236 ms  1.757 ms
...
< Date: Tue, 09 Jan 2018 11:09:40 GMT
< Server: Apache
...
Une fois que c'est fait, on peut lancer un navigateur Web directement vers la carte, ici avec OpenStreetMap (afin de rejoindre les recherches de l'autre groupe de travail) :
```
