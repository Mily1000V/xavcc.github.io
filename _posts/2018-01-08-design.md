...
Tels de robots, elles et ils répétaient des préceptes injectés par des enseignants plein de bonnes volontés mais parfois déconnectés des réalités hors des murs de l'école. Par exemple, nombre d'élèves inénieures n'apprécient par de travailler avec Arduino ou Raspberry car en cours ils et elles ne font que de "copy-past" (sic). D'autres issues de filière environnement sont capables d'appréhender le concept d'Analyse du Cycle de Vie ([ACV](https://fr.wikipedia.org/wiki/Analyse_du_cycle_de_vie)) mais n'ont jamais essayé par-eux même, ou avec d'autres d'une autre école, de tirer avantage de l'informatique, au sens large, dans cette analyse. Les étudiant.e.s en développement web ont peu ou pas de notion de sécurité. 
...
Comme ces deux actions leurs ont pris très peu de temps à réaliser, mais leurs donnent à analyser et comprendre pour plusieurs heures après la séance, je leurs ai proposé.e.s une manipulation supplémentaire plus ludique (qui ouvre également la porte à la compréhension approfondie des internets) :
