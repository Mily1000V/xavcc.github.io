...
Dès le début, j'ai demandé aux personnes présentes d'ouvrir un 1er pad central, wiki dynamique, accesible à toutes et tous qui sera le carnet de bord de cette séance. Il est choisi et produit par les apprenants et apprenantes, le facilitateur ou facilitatrice n'en n'est pas gestionnaire.
