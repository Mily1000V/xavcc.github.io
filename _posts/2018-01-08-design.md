...
### Retour sur les travaux pratiques
...
Lorsqu'elles et ils eurent fini de mettre en commun leurs pads documentés dans le carnet de bord et de discuter brièvement des résultats obtenus et des interrogations soulevées, le groupe dans son ensemble obtint un consensus de résumant la séance. je le résumérai en essayant de respecter leurs mots :

" La simplicité graphique et d'usage de la page web est notée comme un puissant attractif de l'utilisateur, une efficacité qui leur parrait masquer, plus ou moins volontairement, la nécessité de transparence des contitions d'utilisation. La question de l'obligation légale est posée, est-ce à l'auteur de la page de l'assumer ou uniquement aux services tiers utilisés ? Si cette intiative Traveltext passe pour moralement acceptable dans un univers techno-entrepreneurial, elle ne garantit en rien le respect de la vie de la vie privée des visiteurs de la page web, ni des utilisateurs du service et ne garantit pas non plus l'anonymisation et la sécurisation des données transmises. 

Quelques participant.e.s évoquèrent timidement le [RGPD](https://fr.wikipedia.org/wiki/R%C3%A8glement_g%C3%A9n%C3%A9ral_sur_la_protection_des_donn%C3%A9es). (Juriquement une entreprise qui maintient un servie hors U.E est tenue de respecter le RGPD, dès lors que les données concernées sont celles de citoyens européens (principe d'extra-territorialité du RGPD)).
